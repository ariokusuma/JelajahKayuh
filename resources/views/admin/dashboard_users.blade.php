                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                            <a href="{{ route('add_user') }}" class="flex items-center justify-center text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                            ...
                                            {{-- Profile --}}
                                                {{-- Gambar --}}
                                                    <div class="pl-4 grid auto-cols-max">
                                                        ...
                                                        @else
                                                            <img class="w-16 h-16 aspect-square rounded-full" src="{{ asset('storage/default_profile.png') }}" alt="default_pfp">
                                                        @endif
                                                    </div>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{ 'dropdown-' . $data->id }}-button" data-dropdown-toggle="{{ 'dropdown-' . $data->id }}" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                        ...
                                        <div id="{{ 'dropdown-' . $data->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="{{ 'dropdown-' . $data->id }}-button">
                                                <li>
                                            ...
                                            <div class="py-1">
                                                <a href="{{ url('/delete-user') . $data->id }}" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
