                        ...
                        <div class="w-full md:w-1/2">
                            <form class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="">
                                </div>
                            </form>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                                    ...
                                                    <div class="relative p-4 bg-white rounded-lg shadow base:p-5">
                                                        ...
                                                        <form action="{{ route('update_user', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="pb-8">
                                                                ...
                                                                {{-- Role --}}
                                                                <div>
                                                                    <label for="role" class="block mb-2 mt-4 text-base text-start font-medium text-gray-900 ">No Hp</label>
                                            ...
                                            <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
                                                ...
                                                <div class="relative p-4 text-center bg-white rounded-lg shadow base:p-5">
                                                    ...
                                                    <div class="flex justify-center items-center space-x-4">
                                                        ...
                                                        <a href="{{ route('delete_item', ['id' => $data->id]) }}" class="py-2 px-3 text-base bg-red font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                                            Hapus Barang
                                                        </a>
                                                    </div>
                                                </div>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{ 'dropdown-' . $data->id }}-button" data-dropdown-toggle="{{ 'dropdown-' . $data->id }}" class="inline-flex items-center p-0.5 text-base font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                        ...
                                        <div id="{{ 'dropdown-' . $data->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-base text-gray-700 " aria-labelledby="{{ 'dropdown-' . $data->id }}-button">
                                                <li>
                                            ...
                                            <div class="py-1">
                                                <a href="{{ route('delete_user', ['id' => $data->id]) }}" class="block py-2 px-4 text-base text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
