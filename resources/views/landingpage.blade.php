                ...
                <section id="DAFTAR" class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                    ...
                    <div class="flex gap-4 justify-center">
                        ...
                        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <img class="rounded-t-lg" src="img/sepeda_gunung.png" alt="" />
                            
                            <div class="p-5">
                                <a href="#">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Sepeda Gunung</h5>
                                </a>
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Cocok dipakai untuk bersepeda ke puncak</p>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-baseline">
                                    <span class="text-3xl font-bold text-blue-700 dark:text-white">Rp250.000</span>
                                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/24 jam</span>
                                    </div>
                                    <a href="/pemesanan" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Pesan</a>
                                </div>
